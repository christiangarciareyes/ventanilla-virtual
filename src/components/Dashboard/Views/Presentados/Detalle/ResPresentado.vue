  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-8">
          <h5 style="font-size: 18px" class="card-title">Vista de la Solicitud</h5>
          <p class="card-category">Esta ventana muestra tu solicitud generada para acceder a los expedientes.</p><br>
        </div>
        <div class="col-md-4">
