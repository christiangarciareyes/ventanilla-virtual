...
<transition name="slide-fade">
  ...
  <div class="container text-center m-t-100 m-b-100 fuente">
    ...
    <h2 class="text-port fuente">
      Consulta de Procesos de Tutela de Derechos
    </h2>
  </div>
  </div>
  </div>
      ...
      <div class="row">
        ...
        <card>
          <div class="row">
            ...
            <div class="m-home-center__section2">
              ...
              <a style="text-decoration:none;" class="m-home-center__section-name">CONSULTA DE PROCESOS DE TUTELA DE DERECHOS</a>
              <div class="m-home-center__section-desc">
              <br>Consulta expedientes y cuadernillos de los procesos de tutela de derechos.<br>
              </div>
            </div>
            </div>
            </transition>
        ...
        <!--
         <div class="row m-t-40 m-b-10">
          ...
          <div class="col-lg-6">
          <label>Ingresa el Número de Expediente</label>
...
export default {
  data: function() {
    return {
      ...
      tabla2: false,
      lista: [
        { value: 'AA', text: 'ACCIÓN DE AMPARO' },
        { value: 'AC', text: 'ACCIÓN DE CUMPLIMIENTO' },
        { value: 'HD', text: 'HÁBEAS DATA' },
        { value: 'HC', text: 'HÁBEAS CORPUS' }
      ],
      proceso: 'AA',
      selected: null,
      show: false,
